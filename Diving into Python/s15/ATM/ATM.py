...
def log_transaction(func):
    ...
    def wrapper(self, *args, **kwargs):
        try:
            ...
            logging.info(f"Транзакция: {func.__name__}, {args[0]}, баланс: {self.display_balance()}")
            return result
        except Exception as e:
            logging.error(f"Ошибка в транзакции {func.__name__}: {e}")
            raise
    return wrapper
