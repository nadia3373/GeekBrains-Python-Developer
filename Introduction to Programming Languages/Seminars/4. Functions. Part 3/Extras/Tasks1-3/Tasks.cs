namespace Extras
{
    class Tasks
    {
        ...
        public static void Task2()
        {
            ...
            // Размер массива генерируется в диапазоне от корня из общего количества единиц и нулей, округлённого в большую сторону, до общего количества единиц и нулей.
